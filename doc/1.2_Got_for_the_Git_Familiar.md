...
## Refs, Branches, Tags vs. Marks, Commits
...
In Got, Marks are named pointers to Commits.
...
That is the only place in Got where that level of indirection to Commits is needed, and it is therefore implemented as a one-off in the WC.
