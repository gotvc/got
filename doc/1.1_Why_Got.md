...
Anyone who knows how to use Git should, in theory, have solved all their problems associated with versioning, syncing, encrypting, and replicating all their data.
...
That's slow.
Got imports happen in parallel, with a small amount of serial computation taking place at the end.
