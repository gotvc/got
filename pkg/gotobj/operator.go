...
func (o *Operator) Select(ctx context.Context, s cadata.Store, root Root, prefix []byte) (*Root, error) {
	var err error
	var x *Root
	if x, err = o.deleteOutside(ctx, s, *x, gotkv.PrefixSpan(prefix)); err != nil {
		return nil, err
	}
...
func (o *Operator) ForEach(ctx context.Context, s cadata.Store, root Root, p string, fn func(o Object) error) error {
	p = cleanPath(p)
